...
public class TemperatureAddThresholdInvalidSensorSeleniumTest {
    ...
    @Test
    public void addInvalidSensorShowsNotFound() throws Exception {
        String base = "http://localhost:" + port + "/";
        driver.get(base);

        DashboardPage page = new DashboardPage(driver);
        // enter sensor 999 which should not exist and a valid threshold
        page.setTempSensorId("999");
        page.setTempMax("50");
        page.clickSetTemp();

        String alert = page.getAlertTextIfPresent(3000);
        assertThat(alert).isNotNull();
        assertThat(alert).contains("Sensor ID not found");
    }
}
