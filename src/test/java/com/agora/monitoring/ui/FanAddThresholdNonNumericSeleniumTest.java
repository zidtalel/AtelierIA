...
public class FanAddThresholdNonNumericSeleniumTest {
    ...
    @Test
    public void addNonNumericShowsValidation() throws Exception {
        String base = "http://localhost:" + port + "/";
        driver.get(base);

        DashboardPage page = new DashboardPage(driver);
        // Use an existing fan id from simulated reader (fan_cpu)
        ...
        assertThat(alert).contains("Invalid min value");
    }
}
